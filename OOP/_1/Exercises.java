package Develhope_Exercise.OOP._1;
...
public class Exercises {
    ...
    private static void exercise2() {
        ...
        for (int i = 0; i < studentNames.size(); i++) {
            studentsList.add(createNewStudent(studentNames.get(i), studentAges.get(i)));
            System.out.println(studentsList.get(i).name + " " + studentsList.get(i).age);
        }
    }
    ...
    private static void exercise3() {
        ...
        double averageAge = 0;
       for (int i = 0; i < newStudent.Students.size(); i++) {
           averageAge = averageAge + newStudent.Students.get(i).age;
       }

       averageAge = Math.floor((averageAge / newStudent.Students.size())*100.0)/100.0;
