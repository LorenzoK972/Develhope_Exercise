package Develhope_Exercise.javabasics._10;
...
public class Main {
    ...
    private static void exercise2() {
        ...
        boolean permission = eurosInPocket > eurosForEntry;
        boolean minAgeToEnter = age >= 18;

        if ((shoeType.equals("fancy")) && (permission && minAgeToEnter)) {
    ...
    private static void exercise3() {
        ...
        if ((grade >= 90) && !isTestRetry) {
            System.out.println("A");
        } else if ((grade >= 80) && !isTestRetry) {
