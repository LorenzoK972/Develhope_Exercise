package Develhope_Exercise.javabasics._14;
...
public class Main {
    ...
    private static void exercise4() {
        ...
        for (
                int timesTableCurrentValue = tableValue; // <---- Edit this line
                timesTableCurrentValue <= (tableValue * 10); // <---- Edit this line
                timesTableCurrentValue = timesTableCurrentValue + tableValue // <---- Edit this line
        ) {
    ...
    private static void exercise5() {
        ...
        for (int timesTableNumber = 1; timesTableNumber <= 10; timesTableNumber++) {
            System.out.println("Times Table " + timesTableNumber + ": ");
            for (int
                 timesTableValue = timesTableNumber;
                 timesTableValue <= (timesTableNumber * 10) ;
                 timesTableValue = timesTableValue + timesTableNumber){
                System.out.print(timesTableValue + ", ");
            }
            System.out.println(" ");
        }
    }
