package Develhope_Exercise.javabasics._17;
...
public class Main {
     ...
     *    2f: The number of kilometers from any 2 places in the world --> short (approssimativamente)
     */
    ...
    public static void exercise3() {
        ...
        System.out.println(myDate.getDayOfWeek() + " " + myDate.getDayOfMonth() + ", the day number " + myDate.getDayOfYear() + " of the year, "
                + myDate.getMonth() + " " + myDate.getYear() + ", the month number " + myDate.getMonthValue());
        LocalDate anotherDate = LocalDate.of(2021, 4, 12);
