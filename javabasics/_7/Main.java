package Develhope_Exercise.javabasics._7;
...
public class Main {
    ...
    private static void exercise1() {
        ...
        System.out.println("Today the weather is " + weather.toUpperCase());
        System.out.println("Today the weather is " + weather.toLowerCase());
    }
    ...
    private static void exercise2() {
        ...
        String middleName = "Federico";
        String lastName = "Cappannella";
    ...
    private static void exercise3() {
        System.out.println("\nExercise 3:");
        double primitive1 = 3.32;
        int primitive2 = 4;
        String textFrom2Primitives = "" + primitive1 + primitive2; // <--- Edit this line
