package Develhope_Exercise.OOP_Advanced._1;
...
public class Exercises {
    ...
    private static void exercise1() {
        ...
        if (ourSet.contains(Set.of(1, 5, 2))) {
    ...
    private static void exercise2() {
        ...
        //2a. What will this output? Apple, Banana, Orange, Kiwi, Mango ma in ordine sparso.
        ...
        //2b. What will this output? Apple, Banana, Orange, Kiwi, Mango, Grapes e Pear, sempre in ordine sparso.
        System.out.println(fruitsSet);
    }
...
//        for (Integer numberA : setA) {            //Questo è l'unico "nested" for che mi è venuto in mente
//            for (Integer numberB : setB) {        //sotto l'ho fatto utilizzando ".contains" e ".add"
//                if (numberA == numberB) {
